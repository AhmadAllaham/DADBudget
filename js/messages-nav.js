...
if(page==='opex.html'||page==='opex-summary.html') import('./opex-fy27-integrity-fix.js?v=20260909-opex-loop-2').catch(e=>console.error('OPEX FY27 integrity fix failed:',e));
