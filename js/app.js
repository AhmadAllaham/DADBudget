...
(function(){
  ...
  function setupShell(){
    ...
    if(nav&&!nav.querySelector('[data-tunis-nav]')){
      const parent=document.createElement('a');parent.dataset.tunisNav='1';parent.href='tunis-budget.html';parent.textContent='Tunis Budget';
      const sub=document.createElement('div');sub.className='tunis-subnav';sub.style.cssText='margin:0 10px 8px 22px;padding-left:10px;border-left:1px solid rgba(255,255,255,.18)';
